...
const RendezvousProtocolFinalization = new FinalizationRegistry(ptr => wasm.__wbg_rendezvousprotocol_free(ptr));
/**
*/
export class RendezvousProtocol {
    ...
    static __wrap(ptr) {
        ...
        obj.ptr = ptr;
        RendezvousProtocolFinalization.register(obj, obj.ptr, obj);
        return obj;
    }
    ...
    */
    initialOutgoingFrames() {
        const ret = wasm.rendezvousprotocol_initialOutgoingFrames(this.ptr);
        return ret;
    }
    /**
    * @returns {boolean}
    */
    isNominator() {
        const ret = wasm.rendezvousprotocol_isNominator(this.ptr);
        return ret !== 0;
    }
    /**
    ...
    */
    nominatedPath() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.rendezvousprotocol_nominatedPath(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    addChunk(pid, chunk) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.rendezvousprotocol_addChunk(retptr, this.ptr, pid, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            if (r1) {
    ...
    */
    processFrame(pid) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.rendezvousprotocol_processFrame(retptr, this.ptr, pid);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    nominatePath(pid) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.rendezvousprotocol_nominatePath(retptr, this.ptr, pid);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    createUlpFrame(outgoing_data) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.rendezvousprotocol_createUlpFrame(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
function getImports() {
    ...
    imports.wbg.__wbg_warn_e57696dbb3977030 = typeof console.warn == 'function' ? console.warn : notDefined('console.warn');
    imports.wbg.__wbg_error_fe807da27c4a4ced = typeof console.error == 'function' ? console.error : notDefined('console.error');
    imports.wbg.__wbg_info_9e6db45ac337c3b5 = typeof console.info == 'function' ? console.info : notDefined('console.info');
    imports.wbg.__wbg_debug_8db2eed1bf6c1e2a = typeof console.debug == 'function' ? console.debug : notDefined('console.debug');
