<script lang="ts">
  ...
  import {
    ...
    conversationDrafts,
  } from '~/app/ui/components/partials/views/conversation/drafts';
  import {prepareFilesForMediaComposeModal} from '~/app/ui/components/partials/views/conversation/helpers';
  import ComposeBar from '~/app/ui/components/partials/views/conversation/internal/compose-bar/ComposeBar.svelte';
  import TopBar from '~/app/ui/components/partials/views/conversation/internal/top-bar/TopBar.svelte';
  import type {ConversationViewProps} from '~/app/ui/components/partials/views/conversation/props';
  import type {
    ConversationRouteParams,
    ModalState,
    RemoteConversationViewModelStoreValue,
  } from '~/app/ui/components/partials/views/conversation/types';
  import Welcome from '~/app/ui/components/partials/views/welcome/Welcome.svelte';
  ...
  let chatViewComponent: SvelteNullableBinding<ChatView> = null;
