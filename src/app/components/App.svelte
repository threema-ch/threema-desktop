<script lang="ts">
  ...
  import AsideContactDetails from '~/app/components/panels/aside/ContactDetails.svelte';
  import AsideGroupDetails from '~/app/components/panels/aside/GroupDetails.svelte';
  import MainConversation from '~/app/components/panels/main/Conversation.svelte';
  import MainProfile from '~/app/components/panels/main/Profile.svelte';
  import MainWelcome from '~/app/components/panels/main/Welcome.svelte';
  import ModalContactEdit from '~/app/components/panels/modal/ContactEdit.svelte';
  import ModalGroupEdit from '~/app/components/panels/modal/GroupEdit.svelte';
  import NavContactAdd from '~/app/components/panels/nav/ContactAdd.svelte';
  import NavContactAddDetail from '~/app/components/panels/nav/ContactAddDetail.svelte';
  import NavContactList from '~/app/components/panels/nav/ContactList.svelte';
