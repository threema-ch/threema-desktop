<script lang="ts">
  ...
  import {type ContactReceiver} from '~/app/components/receiver';
  import Receiver from '~/app/components/receiver/Receiver.svelte';
  ...
  import {contactListFilter, showFullNameAndNickname} from '.';
