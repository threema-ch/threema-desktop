<script lang="ts">
  ...
  import EnterLinkingCode from '~/app/components/bootstrap/EnterLinkingCode.svelte';
  import EnterNewPassword from '~/app/components/bootstrap/EnterNewPassword.svelte';
  import EnterThreemaId from '~/app/components/bootstrap/EnterThreemaId.svelte';
  import SuccessLinked from '~/app/components/bootstrap/SuccessLinked.svelte';
  import Welcome from '~/app/components/bootstrap/Welcome.svelte';
  ...
  import {type BootstrapParams, type ContextStore, type ProcessStep} from '.';
