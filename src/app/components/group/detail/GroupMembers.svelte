<script lang="ts">
  ...
  import LinkElement from '~/app/components/contact/detail/LinkElement.svelte';
  import GroupMember from '~/app/components/group/detail/GroupMembers/GroupMember.svelte';
  import DeprecatedReceiver from '~/app/components/receiver/DeprecatedReceiver.svelte';
