<script lang="ts">
  ...
  import {elementExists} from '~/app/components';
  import {
    filterContacts,
    getStores,
  ...
  import {type ContactTab} from '~/app/components/navigation/ContactTabSwitcher/index';
  ...
  $: if (visible && elementExists(searchInput)) {
    searchInput.focus();
  }
