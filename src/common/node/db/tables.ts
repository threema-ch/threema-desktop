...
export const tContact = new (class TContact extends Table<DBConnection, 'TContact'> {
     ...
     */
    public nickname = this.column('nickname', 'string');
...
> {
     ...
     * The message UID.
     */
    public messageUid = this.column('messageUid', 'bigint');
    /**
     ...
     */
    public fileId = this.optionalColumn<FileId>('fileId', 'custom', CUSTOM_TYPES.FILE_ID);
    /**
     * Thumbnail file ID assigned by the file storage.
     */
    public thumbnailFileId = this.optionalColumn<FileId>(
        'thumbnailFileId',
        'custom',
        CUSTOM_TYPES.FILE_ID,
    );
    /**
