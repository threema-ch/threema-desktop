 ...
 * possible to the `ReceiverListItemProps` that the contact list item component expects, excluding
 * props that only exist in the ui layer.
 */
export interface ReceiverListItemViewModel<TReceiver extends AnyReceiver> {
