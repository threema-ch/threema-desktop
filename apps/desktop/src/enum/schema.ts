 ...
 * @generate name convert
 */
export enum CspE2eMessageReactionType {
    REACTION = 0x82,
}
/**
 ...
 * @generate name convert
 */
export enum CspE2eGroupMessageReactionType {
    GROUP_REACTION = 0x83,
}
...
export enum ElectronIpcCommand {
    ...
    CHECK_FALLBACK_OPP_FILE = 'checkFallbackOppFile',
    CHECK_OPP_FILE = 'checkOppFile',
    ...
    INVALID_CERTIFICATE_PINS = 'invalidCertificatePins',
